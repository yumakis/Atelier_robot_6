...
class Robot():
    ...
    def __init__(self):
        #coordonnees du robot dans le repère du monde
        self.x = 0
        self.y = 0
        self.theta = 0

        #vitesse lineaire dans le repère du monde
        self.vLin = 0
        #vitesse angulaire dans le repère du monde
        self.vTheta = 0

        #coordonnees du robot dans le repère robot à l'instant t
        self.dx = 0
        self.dy = 0
        self.dTheta = 0
    ...
    def DK(self):
        ...
        #en vitesses lineaire (m/s) vLin et vitesse angulaire (rad/s) vTheta dans le repère monde
        vG = self.motorLeft.w
    ...
    def odom(self):
        #calcule les deplacements dX, dY, et dTheta entre les instants t et t + dt dans le repère du robot
        self.dTheta = self.vTheta * Robot.dt
        dL = self.vLin * Robot.dt
        #projection du deplacement dL dans le repère monde
